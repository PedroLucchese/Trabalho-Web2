                        ...
                        <?php
                            ...
                            if (!empty($busca) && $tipoBusca == "id")
                            {
                                ...
                                if ($produto)
                                {
                                    ...
                                    echo "<tr>";
                                    echo "<td style='width: 5px; cursor: pointer'><a style='color: black' href='./produto_detalhe.php?id=$produtoId'>Editar</a></td>";
                                    echo "<td style='width: 5px; cursor: pointer'><a style='color: black' href='./remove_produto.php?id=$produtoId'>Apagar</a></td>";
                            ...
                            if ($produtos)
                            {
                                foreach ($produtos as $produto)
                                {
                                    ...
                                    echo "<tr>";
                                    echo "<td style='width: 5px; cursor: pointer'><a style='color: black' href='./produto_detalhe.php?id=$produtoId'>Editar</a></td>";
                                    echo "<td style='width: 5px; cursor: pointer'><a style='color: black' href='./remove_produto.php?id=$produtoId'>Apagar</a></td><br></br>";
                                    echo "<td>" . $produto->getNome() . "</td>";
                                    echo "<td>" . $produto->getCodProduto() . "</td>";
                                    echo "<td>" . $produto->getDescricao() . "</td>";
                                    echo "</tr>";
